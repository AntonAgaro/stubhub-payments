# StubHub payments service

The independently deployable payments service for the StubHub clone study project. It currently retains the template's removable notes module and contains no StubHub business behavior.
